...
export default function WashoutsDumpster() {
    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[40vh] flex items-center justify-center text-white">
        ...
        <div className="container mx-auto px-4 z-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Washouts & Dumpster Rental</h1>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-8">Convenient Waste Management Solutions</h2>
            <div className="prose prose-lg">
              <p className="mb-6">
                Our washout and dumpster rental services provide efficient waste management solutions for your construction and renovation projects.
              </p>
              
              <h3 className="text-2xl font-bold mb-4">Dumpster Specifications</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-red-600 mr-2">•</span>
                  <div>
                    <h4 className="font-bold">Size</h4>
                    <p>16' x 8' x 2' box (holds 7 yards of material)</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-red-600 mr-2">•</span>
                  <div>
                    <h4 className="font-bold">Rental Terms</h4>
                    <p>Weekly rentals with flexible scheduling options</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-red-600 mr-2">•</span>
                  <div>
                    ...
                    <p>Prompt and reliable delivery and pickup service</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-red-600 mr-2">•</span>
                  <div>
                    ...
                    <p>Custom project pricing available for long-term rentals</p>
                  </div>
                </li>
              </ul>
            </div>
