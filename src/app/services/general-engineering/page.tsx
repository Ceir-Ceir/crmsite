...
export default function GeneralEngineeringPage() {
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              We provide a full range of engineering services to support your construction and development projects.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <Card padding="lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Site Preparation</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Expert site preparation services to ensure your project starts on solid ground.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    <span className="text-gray-600">Grading and leveling</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    <span className="text-gray-600">Soil stabilization</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    <span className="text-gray-600">Drainage solutions</span>
                  </li>
                </ul>
              </Card>
            </motion.div>
            ...
            >
              <Card padding="lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Infrastructure Development</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Building the foundation for your project's success with comprehensive infrastructure solutions.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    <span className="text-gray-600">Road construction</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    <span className="text-gray-600">Utility installation</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-600 mr-2">•</span>
                    <span className="text-gray-600">Storm water management</span>
                  </li>
                </ul>
              </Card>
            </motion.div>
          ...
          >
            <Card padding="lg">
              ...
              <form action="https://formsubmit.co/crmco1@icloud.com" method="POST" className="space-y-6">
                ...
                <input type="hidden" name="_subject" value="New Quote Request - General Engineering" />
                <div>
