...
export default function DemolitionExcavation() {
    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[40vh] flex items-center justify-center text-white">
        ...
        <div className="container mx-auto px-4 z-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Demolition & Excavation</h1>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-8">Expert Demolition and Excavation Services</h2>
            <div className="prose prose-lg">
              <p className="mb-6">
                Our experienced team provides comprehensive demolition and excavation services, ensuring your project starts on solid ground.
              </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold">Site Preparation</h4>
                    <p>Professional grading and site preparation to ensure optimal conditions for construction.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-red-600 mr-2">•</span>
                  <div>
                    <h4 className="font-bold">Trenching Services</h4>
                    <p>Precise trenching for utilities and foundations with proper compaction techniques.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-red-600 mr-2">•</span>
                  <div>
                    <h4 className="font-bold">Utility Trenching</h4>
                    <p>Expert excavation for utility installations with minimal disruption to surrounding areas.</p>
                  </div>
                </li>
              </ul>
            </div>
