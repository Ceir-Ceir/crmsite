...
// For now, we'll create a simple blog listing
const blogPosts = [
  {
    slug: "top-insights-on-excavation-safety-tips-san-diego",
    title: "Top Insights on Excavation Safety Tips San Diego",
    excerpt: "Essential safety guidelines and best practices for excavation projects in San Diego County.",
    date: "2025-06-02",
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <AnimatedLink href="/blog" isScrolled={isScrolled}>Blog</AnimatedLink>
          ...
          >
            <nav className="container mx-auto px-4">
              <div className="flex flex-col space-y-4">
                <ServicesDropdown isScrolled={isScrolled} />
                <AnimatedLink href="/about" className="px-4 py-2 text-black hover:text-red-600 transition-colors duration-200">
                  About
                </AnimatedLink>
                <AnimatedLink href="/blog" className="px-4 py-2 text-black hover:text-red-600 transition-colors duration-200">
                  Blog
                </AnimatedLink>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Providing reliable, high-quality construction services to San Diego County since 1997. 
                We're committed to excellence in every project.
              </p>
            </div>
          </div>
