...
export default async function BlogPost({ params }: BlogPostProps) {
  ...
  const MDXContent = (await import(`@/app/blog/${params.slug}.mdx`)).default;
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <AnimatedLink href="/" className="text-2xl font-bold text-red-600">
              <Image src="/assets/logo.png" alt="CRM Construction Logo" width={150} height={75} className="h-14 w-auto" />
            </AnimatedLink>
            <button
            ...
            <section className="mt-16">
              <Card padding="lg">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8">Get in touch with us today for a free quote and consultation.</p>
                  <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                    <Button href="/contact" variant="primary">Get a Quote</Button>
                    <a href="tel:+16197784997" className="text-xl font-bold text-gray-900 hover:text-red-600 transition">(619) 778-4997</a>
                  </div>
                </div>
              </Card>
            </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="bg-white rounded-lg px-4 py-2"><span className="text-red-600 font-bold">Veriforce</span></div>
                <div className="bg-white rounded-lg px-4 py-2"><span className="text-red-600 font-bold">ISNetworld</span></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4">Our Mission</h3>
              <p className="text-gray-400">Providing reliable, high-quality construction services to San Diego County since 1997. We're committed to excellence in every project.</p>
            </div>
          </div>
